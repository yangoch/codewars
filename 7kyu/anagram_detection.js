...
const isAnagram = function (test, original) {
  const sortedOriginalString = original.toLowerCase().split("").sort().join("");
  const sortedTestString = test.toLowerCase().split("").sort().join("");

  return sortedOriginalString === sortedTestString;
};
